            ...
            if "source" not in entry:  # coco
                ...
                if source == "hico":
                    abs_path = os.path.join(
                        "/DATA1/Benchmark/hico_20160224_det/images/train2015",
                        entry["file_name"],
                    )
                elif source == "300wLP":
                    abs_path = os.path.join(
                        "/DATA1/Benchmark/300W_LP", entry["file_name"]
                    )
                elif source == "frei":
                    abs_path = os.path.join(
                        "/DATA1/Benchmark/FreiHand/training/rgb", entry["file_name"]
                    )
                ...
                if source == "hico":
                    for i in range(6):
                        for obj in label:
                            items.append(
                                {"path": abs_path, "id": entry["id"], "source": source}
                            )
                            labels.append(obj)
